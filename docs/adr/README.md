...
| [0030](0030-portas-fisicas-subdivisao-de-enderecamento.md) | Portas físicas: a porta é subdivisão de **endereçamento**, e a repartição tem um só dono | proposto (pré-impl.) | 2026-08-30 |
